...
void
TdmaController::AddTdmaSlot (uint32_t slotPos, Ptr<TdmaMac> macPtr) // macPtr is TdmaMacQueue::SetMacPtr
{
...
void
TdmaController::ScheduleTdmaSession (const uint32_t slotNum) // important linked with tdma-helper file line 273-307
{
